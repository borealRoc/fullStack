...
// 类组件
export default class CoreGramma extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <h2 className="comp-title">React核心语法</h2>
                <ul>
                    <li>
                        <h3>1. react组件</h3>
                        <p>1.1、class组件：React的世界里一切皆是组件，使用class语法构建一个最基本的组件</p>
                        {/* 组件属性传值: 传入属性是只读的 */}
                        <p>1.2、函数组件：<Welcome txt='函数组件'/></p>
                    </li>
                    <li>
                        <h3>2. 属性传递: 动态属性是一个表达式</h3>
                        <p>2.1、动态插值：{name}</p>
                    ...
                    <li>
                        ...
                        <p>6.2、按需引入<Input size="large" placeholder="small size" /></p>
                    </li>
                </ul>
            </div>
        )
