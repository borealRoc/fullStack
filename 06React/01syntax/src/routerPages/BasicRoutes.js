...
import { GuardsRoute, Login } from './GuardsRoutes'
        ...
        <div className='react-router'>
            <BrowserRouter>
                <List className="link-part">
                    ...
                    <List.Item><Link to="/lifecycle">4.路由守卫--React组件生命周期</Link></List.Item>
...
export default class ReactRouterComp extends Component {
    render() {
        return (
